...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ListStore = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../store/ListStore\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

	var _ListStore2 = _interopRequireDefault(_ListStore);

	var _ButtonActions = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../actions/ButtonActions\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	var MenuBox = function (_Component) {
		...
		function MenuBox(props) {
			...
			_this.state = {
				viewRange: 'all',
				listArr: _ListStore2.default.getAll()
			};
			return _this;
		}
